...
(function( $ ){
	...
	$('#mu-event-counter').countdown('2020/02/10').on('update.countdown', function(event) {
	  var $this = $(this).html(event.strftime(''
	    + '<span class="mu-event-counter-block"><span>394</span> Cenários</span> '
	    + '<span class="mu-event-counter-block"><span>15</span> Suítes</span> '
	    + '<span class="mu-event-counter-block"><span>52</span> Minutos</span> '));
	});
